                                    ...
                                    <tbody>
                                        {users.data.map(user => (
                                            <tr key={user.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td className="px-3 py-2 text-white text-nowrap">{user.name}</td>
                                                ...
                                                <td className="px-3 py-2 text-nowrap text-right">
                                                    <Link className="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1" href={route('user.edit', user.id)}>
                                                        Edit
                                                    </Link>
                                                    <button
